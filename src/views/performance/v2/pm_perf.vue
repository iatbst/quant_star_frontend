            ...
            <div style="margin-left: 20px; margin-right: 20px; margin-top: 20px; margin-bottom: 20px; width: 100%">
                <el-col :span="24" align="center">
                    ...
                    style="width: 100%;">
                        ...
                        <el-table-column label="PM-1" min-width="10%" align="center">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="PM-2" min-width="10%" align="center">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="PM-3" min-width="10%" align="center">
                            <template slot-scope="scope">
                ...
                <el-row :gutter="0" type="flex" >
                    ...
                    <el-col :span="8" align="center">
                        ...
                        style="width: 100%;">
                            ...
                            <el-table-column label="做空" min-width="10%" align="center">
                                <template slot-scope="scope">
                                    {{ scope.row.short.count }} x 
                                    <span v-if="scope.row.short.avg_pnl_ptg < 0" style="color: red">
                                        {{ (scope.row.short.avg_pnl_ptg *100).toFixed(1) }}%
                                    </span>
                                    <span v-else>
                                        {{ (scope.row.short.avg_pnl_ptg *100).toFixed(1) }}%
                                    </span>
                            ...
                            <el-table-column label="做多" min-width="10%" align="center">
                                <template slot-scope="scope">
                                    {{ scope.row.long.count }} x 
                                    <span v-if="scope.row.long.avg_pnl_ptg < 0" style="color: red">
                                        {{ (scope.row.long.avg_pnl_ptg *100).toFixed(1) }}%
                                    </span>
                                    <span v-else>
                                        {{ (scope.row.long.avg_pnl_ptg *100).toFixed(1) }}%
                                    </span>
    ...
    methods: {
        ...
        fetchReport(){
            ...
            getBacktestReportByName(config.masterHost, reportName).then(response => {
                ...
                // 多空
                this.longShortTradeStats[0].short = response.results[0].data.short_90d.all
