   ...
   <el-row :gutter="0" type="flex" >
        ...
        <el-col :span="24">
            ...
            <div align="center" style="margin-bottom: 20px">
                <el-button style="margin-left: 0px" type="info" size="mini"  @click="parseData('all')" :plain="buttonAllPlain">
                    全部
                </el-button> 
                ...
                <el-button type="info" size="mini"  @click="parseData('thisYearHalf2')" :plain="buttonThisYearHalf2Plain">
                 ...
                 <el-button type="info" size="mini"  @click="parseData('1M')" :plain="button1MPlain">
                    1月
                </el-button>                 
