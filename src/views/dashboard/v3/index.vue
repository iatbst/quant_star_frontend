...
<script>
// Components
import orders from '@/views/orders/_orders_fake'

import todayTable from '@/views/dashboard/v3/today_table'
import perfTable from '@/views/dashboard/v3/perf_table'
import positionTable from '@/views/dashboard/v3/position_table'
import balanceTable from '@/views/dashboard/v3/balance_table'
...
import strategyPositions from '@/views/dashboard/v3/strategy_positions'
